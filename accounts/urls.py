...
from .views import account_profile_view, user_activate, AccountLoginView, AccountLogoutView, AccountRegistrationView, \
    AccountUpdateProfileView, AccountRegistrationDoneView
